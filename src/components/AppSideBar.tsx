...
export const SideBar = ({ menu }: SideBarProps) => {
  ...
  return (
    <div
      className={`flex relative rounded-lg py-6 px-4 bg-white h-[calc(100%-132px)] dark:bg-info-1000 shadow-shadow-light-tight/2 transition-all ${!fullWidth ? "w-[80px]" : "w-[180px]"}`}
    >
      <button
