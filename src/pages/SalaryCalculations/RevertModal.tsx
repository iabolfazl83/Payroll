...
export default function RevertModal({ props }: { props: any }) {
          ...
          <div className="flex flex-col gap-8">
              ...
              <div className="flex justify-between items-center">
                <div className="bg-primary dark:bg-surface-primary shadow-shadow-light-tight/1 rounded-4 flex gap-2 px-3 py-1.5 w-fit">
                  ...
                  <span className="text-white font-normal text-xl">
                    {t("wouldYouAgreeToMeMakingTheReturnCalculation")}
                  </span>
                </div>
                <Button
            ...
            <ModalBody className="!p-0">
              <div className="flex flex-col w-full gap-4">
                <div className="flex w-full px-3 py-4 justify-between !bg-gradient-to-r from-white via-[#EEF9FF] to-white dark:bg-gradient-to-r dark:from-[#01101A] dark:via-[#022C3D] dark:to-[#01101A]">
                  <div className="flex gap-3">
                    <div>
                      <Calculator fill="secondary-1000 dark:text-white" />
                    </div>
