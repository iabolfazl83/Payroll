...
export default function RequestedCompanies() {
  ...
  const handleNavigateToAllCompanies = () => {
    navigate("/company/all-companies");
  };
            ...
            <div className="flex flex-col justify-between gap-3.5 h-full">
              <div className="flex justify-between">
                <div className="flex gap-2">
                  ...
                  <Button className="flex items-center gap-2 bg-secondary-400 dark:bg-surface-200 shadow-shadow-light-tight/1 !rounded-4 !px-3 !py-1.5 w-fit">
              ...
              <div className="flex flex-col h-full justify-between">
                <div className="grid grid-cols-4 gap-3">
                  {companies.map((company) => (
                    <button
                      key={company.id}
                      className="bg-white dark:bg-info-1000 rounded-5 shadow-shadow-light-tight/1 px-5 py-4 flex flex-col gap-2 cursor-pointer"
                    ...
                    >
                      <div className="flex justify-between border-b-1 border-netural-100 pb-1">
                        ...
                        <div className="flex gap-1">
                          <Button className="px-1 py-0.5 flex items-center gap-1 !rounded-2 bg-white dark:bg-info-1000 shadow-shadow-light-tight/1 dark:shadow-shadow-dark-tight/1 !h-5">
                          ...
                          <Button
                            isIconOnly
                            className="!rounded-2 !min-w-fit !w-5 !h-5 p-1 bg-white dark:bg-info-1000 shadow-shadow-light-tight/1 dark:shadow-shadow-dark-tight/1"
                          >
                      ...
                      <div>
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="flex gap-4">
                            ...
                            <span className="text-secondary-800 dark:text-white font-normal text-sm">
                              {company.location}
                            </span>
                          </div>
                          <div className="flex gap-4">
                        ...
                        <div className="flex justify-end">
                          <Button
                            className="bg-white dark:bg-info-1000 !rounded-2 shadow-shadow-light-tight/1 dark:shadow-shadow-dark-tight/1 px-1 py-0.5 h-5"
