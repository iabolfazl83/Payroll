...
import ModalComprehensive from "@/pages/Reporting/LegalReports/Comprehensive/ModalComprehensive.tsx";
...
export default function PageTabs({ props }: { props: any }) {
  ...
  return (
    <div className="flex gap-3">
      ...
      <ModalComprehensive isOpen={isOpen} onOpenChange={onOpenChange} />
      <FilterModal
        props={{
          data: {
