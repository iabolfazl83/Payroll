...
export default function ModalTaxOffice({
  isOpen,
  onOpenChange,
  isShowMode,
  isEditMode,
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      codeNumber: Yup.string().required("codeNumber Required"),
                ...
                <InputGrid columns={2}>
                  ...
                  <div>
                    <AppInput
                      props={{
                        label: t("codeNumber"),
                        placeholder: t("describeCodeNumber"),
                        classNames: {
                          selectorButton: `${isShowMode && "!hidden"}`,
                        },
                        isShowMode,
                  ...
                  <div>
                    <AppInput
                      props={{
                        label: t("phoneNumber"),
                        placeholder: t("describePhoneNumber"),
                        classNames: {
                          selectorButton: `${isShowMode && "!hidden"}`,
                        },
                        isShowMode,
