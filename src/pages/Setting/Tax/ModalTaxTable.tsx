...
export default function ModalTaxTable({
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      currentYear: Yup.string().required("currentYear Required"),
  ...
  const DUMMY_DATA: TaxBracketItem[] = [
    {
      monthlyFrom: 0,
      monthlyTo: 1980000000,
      yearlyFrom: 0,
      yearlyTo: 1440000000,
      taxRate: "Exempt",
    },
    {
      monthlyFrom: 1980000001,
      monthlyTo: 3960000000,
      yearlyFrom: 1440000001,
      yearlyTo: 2880000000,
      taxRate: "10%",
    },
    {
      monthlyFrom: 3960000001,
      monthlyTo: 5940000000,
      yearlyFrom: 2880000001,
      yearlyTo: 4320000000,
      taxRate: "15%",
    },
    {
      monthlyFrom: 5940000001,
      monthlyTo: 9999999999,
      yearlyFrom: 4320000001,
      yearlyTo: 9999999999,
      taxRate: "20%",
    },
  ];
          ...
          <div className="flex flex-col gap-8">
            ...
            <ModalBody className="!p-0">
              ...
              >
                ...
                {isShowMode ? (
                  <TaxTableInnerPopupShowMode props={{ data: DUMMY_DATA }} />
                ) : (
                  <TaxTableInnerPopup
                    props={{
