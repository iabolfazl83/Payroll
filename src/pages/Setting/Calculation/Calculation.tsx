...
import PageTabs from "@/pages/Setting/Calculation/PageTabs.tsx";
...
export default function Calculation() {
  ...
  const DUMMY_DATA = [
    {
      ...
      referenceCalculations: "Unit Calculation",
      referenceDetails: "Sales",
    ...
    },
    {
      ...
      no: 2,
      title: "Sales Calculations",
      referenceCalculations: "Revenue Calculation",
      referenceDetails: "Sales",
    ...
    },
    {
      ...
      no: 3,
      title: "Sales Calculations",
      referenceCalculations: "Discount Calculation",
      referenceDetails: "Sales",
    ...
    },
    {
      ...
      no: 4,
      title: "Sales Calculations",
      referenceCalculations: "Commission Calculation",
      referenceDetails: "Sales",
    ...
    },
    {
      ...
      title: "Sales Calculations",
      referenceCalculations: "Unit Calculation",
      referenceDetails: "International",
  ...
  const tableColumns = [
    ...
    { key: "referenceCalculations", label: "Reference Calculations" },
